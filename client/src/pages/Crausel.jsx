...
const Crausel = () => {
  return (
    <div className="bg-[#272D22] pb-[80px]">
      <h1 className="text-center text-2xl font-bold text-white mb-6">Our Best o2</h1>

      <div className="flex flex-col md:flex-row justify-start items-center text-center 
                      w-full max-w-[1024px] mx-auto border-2 border-gray-600 
                      rounded-4xl px-4 md:px-8 py-6 md:py-8">
        ...
        <div className="w-full md:w-[400px] text-justify px-3">
          ...
          <div>
            <button className="text-white border px-4 py-1 mt-4 hover:bg-white hover:text-black transition">
              Explore
            </button>
          </div>
        </div>
