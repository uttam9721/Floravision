...
const Plants = () => {
  ...
  // 🌿 Plant Data
  const plants = [
    { img: card, name: "Aglaonema plant", price: 300 },
    { img: P1, name: "Plantain plant", price: 320 },
    { img: c1, name: "Cactus plant", price: 250 },
    { img: card, name: "Indoor plant", price: 299 },
    { img: s1, name: "Swiss plant", price: 350 },
    { img: card, name: "Desk plant", price: 199 },
  ];

  return (
    <div className="bg-[#1B2316]">

      <h1 className="text-center text-2xl font-bold text-white p-18">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center py-10 gap-y-38">
        ...
        {plants.map((plant, index) => (
          ...
          <div
            key={index}
            className="w-[350px] bg-[#272E22] border-2 border-[#4F554B] rounded-4xl px-8"
          >

            <img className="mt-[-100px]" src={plant.img} alt="" />

            <div className="text-start ml-3.5">
              ...
              <p className="text-white">
                The {plant.name} is known for its attractive foliage and ease of care.
              </p>
